# -*- coding: utf-8 -*-
"""
Created on Mon Jun 17 20:09:29 2013
...
class XAReal_OH0(SourceReal):
    """
    kospi200 options quote tick real time receive
    """
    def __init__(self,shcode=None,DataType='dictionary'):
        super(XAReal_OH0,self).__init__("XA_DataSet.XAReal")
