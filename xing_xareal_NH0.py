...
class XAReal_NH0(SourceReal):
    ...
    def OnSignal(self):
        if self.DataType == 'dictionary':
            ...
            self.data = []
            self.append(self.GetFieldData('OutBlock','hotime'))
            self.append(self.GetFieldData('OutBlock','hotime1'))
            self.append(self.GetFieldData('OutBlock','offerho1'))
            self.append(self.GetFieldData('OutBlock','bidho1'))
            self.append(self.GetFieldData('OutBlock','offerrem1'))
            self.append(self.GetFieldData('OutBlock','bidrem1'))
            self.append(self.GetFieldData('OutBlock','offercnt1'))
            self.append(self.GetFieldData('OutBlock','bidcnt1'))
            self.append(self.GetFieldData('OutBlock','offerho2'))
            self.append(self.GetFieldData('OutBlock','bidho2'))
            self.append(self.GetFieldData('OutBlock','offerrem2'))
            self.append(self.GetFieldData('OutBlock','bidrem2'))
