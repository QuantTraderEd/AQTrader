...
if __name__ == '__main__':
    ...
    position_info_dict['datetime'] = dt.datetime.strptime('2017-04-04 15:10:03.456506', '%Y-%m-%d %H:%M:%S.%f')
    position_info_dict['buysell'] = 'sell'
    position_info_dict['shortcd'] = '201M5305'
    position_info_dict['avgexecprice'] = 0.05
    position_info_dict['holdqty'] = 5
