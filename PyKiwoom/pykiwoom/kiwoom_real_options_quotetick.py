...
class KiwoomOptionsQuoteTick(KiwoomReal):
    """
    Real: options quote tick
    """

    def __init__(self, kiwoom_session=None):
        super(KiwoomOptionsQuoteTick, self).__init__(kiwoom_session=kiwoom_session)
