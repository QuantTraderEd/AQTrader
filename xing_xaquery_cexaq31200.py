...
class XAQuery_cexaq31200(SourceQuery):
    ...
    def OnSignal(self):
        ...
        for i in xrange(nCount):
            data3 = {}
            data3['FnoIsuNo'] = self.GetFieldData('CEXAQ31200OutBlock3','FnoIsuNo',0)
            data3['IsuNm'] = self.GetFieldData('CEXAQ31200OutBlock3','IsuNm',0)
            data3['BnsTpCode'] = self.GetFieldData('CEXAQ31200OutBlock3','BnsTpCode',0)
            data3['BnsTpNm'] = self.GetFieldData('CEXAQ31200OutBlock3','BnsTpNm',0)
            data3['UnsttQty'] = self.GetFieldData('CEXAQ31200OutBlock3','UnsttQty',0)
            data3['FnoAvrPrc'] = self.GetFieldData('CEXAQ31200OutBlock3','FnoAvrPrc',0)
            data3['NowPrc'] = self.GetFieldData('CEXAQ31200OutBlock3','NowPrc',0)
            data3['CmpPrc'] = self.GetFieldData('CEXAQ31200OutBlock3','CmpPrc',0)
            data3['EvalPnl'] = self.GetFieldData('CEXAQ31200OutBlock3','EvalPnl',0)
            data3['PnlRat'] = self.GetFieldData('CEXAQ31200OutBlock3','PnlRat',0)
            data3['EvalAmt'] = self.GetFieldData('CEXAQ31200OutBlock3','EvalAmt',0)
